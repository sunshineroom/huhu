                   ...
                   <div class="col-lg-12">
                       <div class="panel panel-default">
                           ...
                           <div class="panel-body">
                               <div class="row">
                                   <div class="col-lg-6">
                                       <form role="form" action="<?php echo U('Admin/Advert/update');?>" method="post" enctype="multipart/form-data">
                                           ...
                                           <div class="form-group">
                                              <input type="radio" name="status" <?php echo $info['status'] == 1? 'checked':''; ?> value="1">展示
                                              <input type="radio" name="status" <?php echo $info['status'] == 0? 'checked':''; ?> value="0">不展示
                                           </div>
                                           <div class="form-group">
                                              <label>广告简介:</label><br>
                                              <textarea style="width:100%;height:100px;" name="content" ><?php echo ($info["content"]); ?></textarea>
                                           </div>
