...
<script type="text/javascript">
    var showurl = "<?php echo U('Admin/Lin/showurl');?>";
    var newsrcurl = "<?php echo U('Admin/Lin/newsrcurl');?>";
    var newcontenturl = "<?php echo U('Admin/Lin/newcontenturl');?>";
    var newlinkurl = "<?php echo U('Admin/Lin/newlinkurl');?>";
    var dellinkurl = "<?php echo U('Admin/Lin/dellinkurl');?>";
</script>
  <div id="page-wrapper">
    <div class="row">
      <div class="col-lg-12">
        <h1 class="page-header">公告栏列表</h1>
      </div>
      <!-- /.col-lg-12 -->
    </div>
    <div class="row">
            ...
            <div class="dataTable_wrapper">
              <div id="dataTables-example_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer">
                <div class="row">
                  ...
                  <p><button type="button" class="btn btn-primary newgong" style="margin-left:30px">新增公告</button></p>
                </div>
                <div class="row">
                  <div class="col-sm-12">
                  <!-- 用户列表遍历 -->
                    <table id="dataTables-example" class="table table-striped table-bordered table-hover dataTable no-footer" role="grid" aria-describedby="dataTables-example_info">
                      <thead>
                        <tr role="row">
                          ...
                          <th class="sorting" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" style="width: 100px;" aria-label="Browser: activate to sort column ascending">href</th>
                          <th class="sorting" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" style="width: 200px;" aria-label="Platform(s): activate to sort column ascending">链接名称</th>
                          <th class="sorting" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" style="width: 70px;" aria-label="Engine version: activate to sort column ascending">是否前台显示</th>
                          <th class="sorting" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" style="width: 30px;" aria-label="CSS grade: activate to sort column ascending">操作</th>
                        </tr>
                      </thead>
                      <tbody>
                        <?php if(is_array($gonginfo)): foreach($gonginfo as $k=>$vo): ?><tr class="gradeA odd" role="row">
                            <td class="sorting_1 sid"><?php echo ($vo["id"]); ?></td>
                            <td id="<?php echo ($vo["id"]); ?>" class="gongsrc"><?php echo ($vo["gongsrc"]); ?></td>
                            <td id="<?php echo ($vo["id"]); ?>" class="gongcontent"><?php echo ($vo["gongcontent"]); ?></td>
                            <td>
                              <?php if(($vo["gongshow"] == 1) ): ?>前台显示&nbsp;&nbsp;&nbsp; <button type="button" id="<?php echo ($vo["id"]); ?>" class="btn btn-info btn-circle isgong"><i class="fa fa-check"></i></button>
                                <?php else: ?> 
                                前台显示&nbsp;&nbsp;&nbsp; <button type="button" id="<?php echo ($vo["id"]); ?>" class="btn btn-warning btn-circle isgong"><i class="fa fa-times"></i></button><?php endif; ?>
                            </td>
                            
                            <td class="center" style="text-align:center">
                               <button type="button" id="<?php echo ($vo["id"]); ?>" class="btn btn-danger btn-circle delgong"><i class="fa fa-times"></i></button>
                            </td>
