...
<script type="text/javascript">
    var showurl = "<?php echo U('Admin/Link/showurl');?>";
    var newsrcurl = "<?php echo U('Admin/Link/newsrcurl');?>";
    var newcontenturl = "<?php echo U('Admin/Link/newcontenturl');?>";
    var newlinkurl = "<?php echo U('Admin/Link/newlinkurl');?>";
    var dellinkurl = "<?php echo U('Admin/Link/dellinkurl');?>";
</script>
  <div id="page-wrapper">
    <div class="row">
      <div class="col-lg-12">
            ...
            <div class="dataTable_wrapper">
              <div id="dataTables-example_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer">
                <div class="row">
                  ...
                  <p><button type="button" class="btn btn-primary newlink" style="margin-left:30px">新增友情链接</button></p>
                </div>
                <div class="row">
                  <div class="col-sm-12">
                  <!-- 用户列表遍历 -->
                    <table id="dataTables-example" class="table table-striped table-bordered table-hover dataTable no-footer" role="grid" aria-describedby="dataTables-example_info">
                      <thead>
                        <tr role="row">
                          ...
                          <th class="sorting" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" style="width: 100px;" aria-label="Browser: activate to sort column ascending">src</th>
                      ...
                      <tbody>
                        <?php if(is_array($linkinfo)): foreach($linkinfo as $k=>$vo): ?><tr class="gradeA odd" role="row">
                            <td class="sorting_1 sid"><?php echo ($vo["id"]); ?></td>
                            <td id="<?php echo ($vo["id"]); ?>" class="linksrc"><?php echo ($vo["src"]); ?></td>
                            <td id="<?php echo ($vo["id"]); ?>" class="linkcontent"><?php echo ($vo["linkcontent"]); ?></td>
                            <td>
                              <?php if(($vo["show"] == 1) ): ?>前台显示&nbsp;&nbsp;&nbsp; <button type="button" id="<?php echo ($vo["id"]); ?>" class="btn btn-info btn-circle isshow"><i class="fa fa-check"></i></button>
                                <?php else: ?> 
                                前台显示&nbsp;&nbsp;&nbsp; <button type="button" id="<?php echo ($vo["id"]); ?>" class="btn btn-warning btn-circle isshow"><i class="fa fa-times"></i></button><?php endif; ?>
                            </td>
                            
                            <td class="center" style="text-align:center">
                               <button type="button" id="<?php echo ($vo["id"]); ?>" class="btn btn-danger btn-circle dellink"><i class="fa fa-times"></i></button>
                            </td>
