...
<head>
	...
	<title><?php echo (C("WEBNAME")); ?>-@我的</title>
	<link rel="stylesheet" href="/Public/Home/Theme/<?php echo ($style); ?>/Css/nav.css" />
	<link rel="stylesheet" href="/Public/Home/Theme/<?php echo ($style); ?>/Css/atme.css" />
                ...
                <!--操作-->
                    ...
                    <!--发布时间-->
                        ...
                        <ul>
                            ...
                            <li style="padding-right:241px"><span><?php echo date('Y-m-d H:i:s',$v['time']) ?></span></li>
...
<!--====================转发样式====================-->
            ...
            <!--头像-->
                ...
                <div class="wb_cons">
                    ...
                    <!--发布内容-->
                        <dd class='content'>
                            <p><span style="color:#ccc;font-weight:bold;">&nbsp;<?php echo ($v["content"]); ?></p>
                        </dd>
                    <!--转发的微博内容-->
                        ...
                        <dd>
                            <div class="wb_turn">
                                ...
                                <?php if($v["isturn"]["max"]): ?><dd>
                                        <div class="turn_img">
                                        <!--小图-->
                                            <img src="/Public/Uploads/Pic/<?php echo ($v["isturn"]["mini"]); ?>" class='turn_mini_img'/>
                                            <div class="turn_img_tool hidden">
                                                <ul>
                                                    ...
                                                    <li>
                                                        <i class='icon icon-bigpic'></i>
                                                        <a href="/Public/Uploads/Pic/<?php echo ($v["isturn"]["max"]); ?>" target='_blank'>&nbsp;查看大图</a>
                                                    </li>
                                                </ul>
                                            <!--中图-->
                                                <div class="turn_img_info">
                                                    <img src="/Public/Uploads/Pic/<?php echo ($v["isturn"]["medium"]); ?>"/>
                                                </div>
                                            </div>
                                        </div>
                                    </dd><?php endif; ?>
                    ...
                    <div class="wb_tool">
                        ...
                        <ul>
                        <?php if(isset($v["kid"])): ?><li><span>收藏于：</span></li>
                            <li>|</li><?php endif; ?>
