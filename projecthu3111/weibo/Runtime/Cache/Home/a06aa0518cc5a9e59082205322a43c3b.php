...
<head>
	...
	<link rel="stylesheet" href="/Public/Home/Theme/<?php echo ($style); ?>/Css/comment.css" />
    ...
    <script type="text/javascript">
        var replyUrl = "<?php echo U('Home/User/reply');?>";
        var delComment = "<?php echo U('Home/User/delComment');?>";
    </script>
<script type='text/javascript'>
    ...
    <!--=====中部=====-->
        ...
        <?php if(is_array($comment)): foreach($comment as $key=>$v): ?><dl>
				...
				<dd>
					...
					<span><?php echo ($v["content"]); ?>（<?php echo (date("Y-m-d H:i:s",$v["time"])); ?>）</span>
				</dd>
				<dd class='tright'>
					<span class='del-comment' cid='<?php echo ($v["id"]); ?>'>删除</span> &nbsp;|&nbsp;
