...
<head>
	...
	<link rel="stylesheet" href="/Public/Home/Theme/<?php echo ($style); ?>/Css/list.css" />
    ...
    <!--=====右侧=====-->
    	<div id='right'>
            ...
            <?php if(is_array($users)): foreach($users as $key=>$v): ?><li>
					<dl class='list-left'>
						<dt>
							<img src="<?php if($v["face50"]): ?>/Public/<?php echo ($v["face50"]); else: ?>/Public/Images/noface.gif<?php endif; ?>" width='50' height='50'/>
						</dt>
						<dd>
