...
<head>
    ...
    <script type='text/javascript'>
        ...
        var reportWeibo = '<?php echo U("Home/Index/reportWeibo");?>';
        var editStyle = '<?php echo U("Home/Index/editStyle");?>';
        var person = '<?php echo U("Home/User/index",array("uid"=>value));?>';
        //我的
        ...
        <!--微博发布框-->
            <div class='send_wrap'>
                ...
                <div class='send_write'>
                    <form action='<?php echo U("Home/Common/send");?>' method='post'  name='weibo'>
